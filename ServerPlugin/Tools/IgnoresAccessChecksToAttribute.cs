...
// Define the class only if the project is built by the loader, because Krafs.Publicizer
...
namespace System.Runtime.CompilerServices
{
    ...
    // This code is required in "production" when the loader builds the plugin
